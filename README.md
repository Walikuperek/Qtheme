...
Use `:root` in CSS to initialize theme atoms, `it's optional`. If you want to use generated by Qtheme *:root variables* in CSS files without providing default ones, your IDE will yell at you because of possible undefined variables.
```css
/* Default variables */
:root {
    --primary: dodgerblue;
